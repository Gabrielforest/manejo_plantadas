...
dados_npar <- read.csv2("ifc.csv",fileEncoding = "latin1")
names(dados_npar)
...
x11()
par(mfrow=c(1,2))
with(dados, plot(hdom1,hdom2, pch="*"))
with(dados, plot(idade2,hdom2, pch="*"))
...
x11()
par(mfrow=c(3,2))
with(dados,plot(idade1,resbcpoli,pch="*",
...
with(dados,plot(idade1,resbcana,pch="*",
...
with(dados,plot(idade1,rescrpoli,pch="*",
...
with(dados,plot(idade1,rescrana,pch="*",
...
with(dados,plot(idade1,resschpoli,pch="*",
...
with(dados,plot(idade1,resschana,pch="*",
