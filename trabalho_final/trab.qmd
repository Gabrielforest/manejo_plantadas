...
dos modelos, foi processada a classificação de sítio. Com isso, foi possível gerar comparações como as destacadas na frequência das mudanças de
classe observadas na Tabela 2, a qual apresenta a comparação entre os dois melhores modelos. Sendo que, essa mesma análise para os demais modelos
está disponível em anexo deste documento, assim como os gráficos das curvas de índice de sítio das alturas dominantes, distribuídas em intervalos de classes, em função do tempo para cada modelo.
...
![Distribuição das alturas dominantes em função da idade para os modelos testados e seus respectivos limites.]()